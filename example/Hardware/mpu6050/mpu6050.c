...
static void run_self_test(void)
{
    ...
    if (result == 0x7) {
		...
		BlueTooth_TransmitPrintf("setting bias succesfully ......\r\n");
    }
}
...
{ 
   ...
   i2cRead(0x68,0x75,1,temp);
	 BlueTooth_TransmitPrintf("mpu_set_sensor complete ......\r\n");
	...
	if(!mpu_init())
  {
	  ...
	  if(!mpu_configure_fifo(INV_XYZ_GYRO | INV_XYZ_ACCEL))
	  	 BlueTooth_TransmitPrintf("mpu_configure_fifo complete ......\r\n");
	  if(!mpu_set_sample_rate(DEFAULT_MPU_HZ))
	  	 BlueTooth_TransmitPrintf("mpu_set_sample_rate complete ......\r\n");
	  if(!dmp_load_motion_driver_firmware())
	  	BlueTooth_TransmitPrintf("dmp_load_motion_driver_firmware complete ......\r\n");
	  if(!dmp_set_orientation(inv_orientation_matrix_to_scalar(gyro_orientation)))
	  	 BlueTooth_TransmitPrintf("dmp_set_orientation complete ......\r\n");
	  if(!dmp_enable_feature(DMP_FEATURE_6X_LP_QUAT | DMP_FEATURE_TAP |
	        DMP_FEATURE_ANDROID_ORIENT | DMP_FEATURE_SEND_RAW_ACCEL | DMP_FEATURE_SEND_CAL_GYRO |
	        DMP_FEATURE_GYRO_CAL))
	  	 BlueTooth_TransmitPrintf("dmp_enable_feature complete ......\r\n");
	  if(!dmp_set_fifo_rate(DEFAULT_MPU_HZ))
	  	 BlueTooth_TransmitPrintf("dmp_set_fifo_rate complete ......\r\n");
	  run_self_test();
	  mpu_set_dmp_state(1);
	  if(!mpu_set_dmp_state(1))
	  	 BlueTooth_TransmitPrintf("mpu_set_dmp_state complete ......\r\n");
  }
}
/**************************************************************************
